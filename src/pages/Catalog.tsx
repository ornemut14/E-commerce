...
import "./catalog.css";
import clearIcon from "../assets/filter-xmark-svgrepo-com.svg";
...
function Catalog() {
  ...
  // 📌 Lee categoría desde URL
  useEffect(() => {
    const categoriaURL = searchParams.get("categoria");

    if (categoriaURL) {
      setCategory(categoriaURL);
    } else {
      setCategory("");
    }
  }, [searchParams]);
      ...
      <div className="catalog-page">
        <div className="filters-wrapper">
          ...
          {(category || material || search) && (
            ...
            >
              <img src={clearIcon} alt="Borrar filtros" />
            </button>
          )}
        </div>
